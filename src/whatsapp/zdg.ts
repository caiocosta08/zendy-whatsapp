...
// 		console.log(`Has: ${WhatsappService.sessions.has(sessionId)}`)
...
// 		console.log({ sessionId, res, SSE, readIncomingMessages, socketConfig })
...
// 		// Usar useMultiFileAuthState em vez de useSession personalizado
...
// 			...socketConfig,
// 			auth: state, // Usar state diretamente em vez do objeto auth complexo
// 			version, // Usar a versão obtida do fetchLatestBaileysVersion
// 			logger,
// 			shouldIgnoreJid: (jid) => isJidBroadcast(jid),
// 			getMessage: async (key) => {
// 				// Retornar uma mensagem padrão simples como no app.js
// 				return { conversation: 'botzdg' } as proto.IMessage;
// 			},
// 		});
